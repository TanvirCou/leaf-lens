    ...
    return (
        <div className='py-10 px-8 md:px-12 lg:px-24 bg-green-950 relative overflow-hidden' id='about'>
            ...
            <div className='pt-8 flex flex-col items-center'>
                <p className={`${font.lobsterFont.className} text-yellow-500 text-2xl md:text-3xl lg:text-4xl`}>About Us</p>
                ...
                <div className='flex flex-col md:flex-row items-center gap-6 pt-8'>
                    ...
                    <div className='w-full md:w-1/2 flex flex-col gap-4'>
                        ...
                        <p className={font.lobsterFont.className}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis ratione rem maxime veniam cum libero voluptas tempora aut saepe similique, eos corporis. Expedita culpa consequatur animi deleniti ullam adipisci iure sequi dolores modi aliquam laudantium,
